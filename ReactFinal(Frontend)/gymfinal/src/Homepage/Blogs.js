...
import dark from '../images/dark-1839088_1280.jpg';

const Blogs= () => {
    return (
        <>
        <div>
       <Image src= {dark} width= "100%" height="450px" /> 
       <h1 className="yel" style={{color:'blue',textAlign:'center'}}>GYM BLOGS </h1>
         </div>
...
<p style={{color:'red'}}>29 June 2022 Fit and Fab Gym Challenge National Winners (Top 15)</p>
...
Belly Fat Is Quite Stubborn And Cannot Be Shed Off Easily. That Is Why You Need To Find The Right Combination Of A Good Workout Routine With The Proper Diet Friendly Foods Which Is The Fastest Way To Lose Belly Fat. 
      ...
      <Container style={{marginTop:'120px'}}>
        <Row >
          ...
          <Col><h4 style={{color:'blue'}}>Grow, Nourish, Sustain Through Food!</h4>
          ...
          <Col><h4 style={{color:'blue'}}>Eat Seasonal, Eat local –</h4>
